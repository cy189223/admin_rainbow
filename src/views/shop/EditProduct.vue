          ...
          <div class="base-content">
            <template v-if="current==0">
              <a-form>
                ...
                <a-form-item label="搜索关键词" :label-col="{ span: 3 }" :wrapper-col="{ span: 12 }">
                  <a-input style="width:400px" v-model="form.search_key" placeholder="请输入" allowClear></a-input>
                  <div class="tips">搜索关键词用于搜索时匹配，每个关键词可用空格隔开，60字以内</div>
                </a-form-item>
                <!-- <div class="tips">搜索关键词用于搜索时匹配，每个关键词可用空格隔开</div> -->
                ...
                <a-form-item label="供应商" :label-col="{ span: 3 }" :wrapper-col="{ span: 12 }">
                  <a-input style="width:400px" v-model="form.supplier" placeholder="选填" allowClear></a-input>
                </a-form-item>
                <a-form-item label="划线价(人民币)" :label-col="{ span: 3 }" :wrapper-col="{ span: 12 }">
                  <PriceInput style="width:400px" v-model="form.line_money_price" placeholder="请输入" allowClear></PriceInput>
                </a-form-item>
                <a-form-item label="售价(人民币)" :label-col="{ span: 3 }" :wrapper-col="{ span: 12 }">
                  <PriceInput style="width:400px" v-model="form.money_price" placeholder="请输入" allowClear></PriceInput>
                </a-form-item>
                <a-form-item label="售价(积分)" :label-col="{ span: 3 }" :wrapper-col="{ span: 12 }">
                ...
                <a-form-item label="是否预售" :label-col="{ span: 3 }" :wrapper-col="{ span: 12 }">
                  ...
                  <!-- <div class="tips">预售倒计时结束前将不可购买</div> -->
                </a-form-item>
    ...
    created() {
      ...
      this.$api.emit('product.show', this.$route.params.uuid).then(res => {
        ...
        this.form = {
          ...
          ean: product.ean,
          line_money_price: product.line_money_price,
          ...
          is_presell: product.is_presell,
          presell_mode: product.presell_mode,
          presell_date: product.presell_date,
