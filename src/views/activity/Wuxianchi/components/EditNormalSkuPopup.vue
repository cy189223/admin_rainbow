<template>
  <a-modal :title="`编辑普通赏`" style="top: 100px;" :visible="true" width="1200px" @cancel="handleCancel">
    <div class="tips">
    </div>
    <a-table class="product-table" :rowKey="row => row.id" :dataSource="list" bordered :pagination="false" size="small">
      ...
      <!-- <a-table-column title="抽中概率" key="number" width="50px">
        <template slot-scope="row">
          <div>
            {{row.odds || '-'}}%
          </div>
