  ...
  <div class="list">
    <div class="content-head" style="margin-bottom: 20px;">
      <div class="sort-keys">
        ...
        <router-link to="/chip/setting" @click="handleDelete(row)" style="margin: 0px 10px;">碎片全局配置</router-link>
    ...
    <a-table class="table" :rowKey="row => row.uuid" :dataSource="list" :pagination="pagination" :size="size">
      <a-table-column title="碎片标题" width="80px">
        <template slot-scope="row">
          {{row.title}}
        </template>
      </a-table-column>
      <a-table-column title="碎片图标" width="100px">
        <template slot-scope="row">
      ...
      <a-table-column title="已发放数量" width="100px">
        <template slot-scope="row">
          {{row.cover_total}}
        </template>
      </a-table-column>
      <a-table-column title="已使用数量" width="100px">
        <template slot-scope="row">
          {{row.used_total}}
        </template>
      </a-table-column>
      ...
      <!-- <a-table-column title="分销/下单奖励" width="80px">
        <template slot-scope="row">
...
<script>
  ...
  import EditForm from "./EditChip.vue"
  const resourceType = 'chips'
  const resourceTypeText = '碎片'
