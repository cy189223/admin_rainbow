<template>
  <a-modal :title="`编辑第${this.info.num}箱概率`" style="top: 100px;" :visible="true" width="1100px" @cancel="handleCancel">
...
<script>
  ...
  export default {
    ...
    methods: {
      initList() {
        // this.$http.get(`/yifanshang/odds?room_id=${this.info.id}`).then(res => {
