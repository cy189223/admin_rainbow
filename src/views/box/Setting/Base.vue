        ...
        return [
          {
            ...
            key: 'is_need_phone',
            type: 'boolean',
            tips: '开启后，仅绑定手机号的用户可参与开盒',
            newline: true,
            required: true,
          },
          {
            title: '显示剩余件数（普通款）',
            key: 'is_show_stock_normal',
            type: 'boolean',
            tips: '在查看奖品列表的界面显示',
            newline: true,
            required: true,
